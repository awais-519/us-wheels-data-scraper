...
def dealer_prices(product_list):
    ...
    json_data = {
        ...
        'tid': 21,
        'ctx': {
            'csrf': 'VmpFPSxNakF5TXkwd09TMHhORlF5TURveU5qb3dOaTR5TXpSYSxWRXpvSTZ4RkhQYUEtVFZ1RzhZZk5KRGo1M25lRlZIT3doNHBnMHNwOUE4PSxNVEUyT0dFdw==',
            'vid': '0661U000005ihTF',
            'ns': '',
            'ver': 45,
            'authorization': '.Q2lsQmNIQkhkV2xrWlVOdmJuUnliMnhzWlhJdVoyVjBSbTl5YlhWc1lYTkNZWE5sWkU5dVRtRnRaUT09.EoNEQZK7PhnInuEmylfea8jekdM3PQAzMyS5ekdAYEM=',
        },
    }

    response = requests.post('https://wheelpros.my.site.com/dealerline/apexremote', cookies=cookies, headers=headers, json=json_data)
